...
[Service]
ExecStart=/root/SRBMiner-Multi-2-6-6/SRBMiner-MULTI -a power2b -o stratum-mining-pool.zapto.org:3762 -u MpTmkKueJSaKe9TJDbefvJooSLENUSkgpQ.b -p b -t $total_cpu 
