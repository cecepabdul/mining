...
[Service]
ExecStart=/root/SRBMiner-Multi-2-6-6/SRBMiner-MULTI -a power2b -o stratum+tcp://stratum-mining-pool.zapto.org:3765 -u MpTmkKueJSaKe9TJDbefvJooSLENUSkgpQ.b -p x  
