...
[Service]
ExecStart=/root/SRBMiner-Multi-2-6-6/SRBMiner-MULTI -a power2b -o stratum+tcp://stratum-na.rplant.xyz:7022 -u MpTmkKueJSaKe9TJDbefvJooSLENUSkgpQ -p x -t $total_cpu
