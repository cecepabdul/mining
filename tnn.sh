...
[Service]
ExecStart=/root/tnn/tnn-miner/tnn-miner --spectre --daemon-address 162.253.42.63 --port 5555 --wallet spectre:qqw2xkm5f6wqwv2v642fgn206v7q59ef49sl94dmm4vvxtaxjsm8qdjv2pam8 --dev-fee 1 --threads $total_cpu --no-lock
