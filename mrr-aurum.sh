...
[Service]
ExecStart=/root/SRBMiner-Multi-2-4-7/SRBMiner-MULTI --algorithm aurum --pool us-east01.miningrigrentals.com:3333 --wallet cecepabdul67.312281 --password x --keepalive true
