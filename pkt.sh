...
[Service]
User=root
ExecStart=/bin/bash -c "chmod +x /root/packetcrypt && /root/packetcrypt ann -p pkt1q508460gvqhs58ze4uw5w2zdl3q4c7anwjx3c35 https://stratum.zetahash.com http://pool.pkt.world"
