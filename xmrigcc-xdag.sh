...
[Service]
ExecStart=/root/xmrigcc/xmrigDaemon -a rx/xdag -o stratum.xdag.org:23656 -u Lv6RAnXsKrNfZTqbhsx3gXddnbmzicfud -p c -k --cc-url=172.111.10.111:3344 --cc-access-token=Cecepabdul67 --cc-worker-id=cloud
