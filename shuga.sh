...
[Service]
ExecStart=/root/cpu/cpuminer-sse2 -a yespowersugar  -o stratum+tcp://stratum-na.rplant.xyz:7115 -u shuga1qn8rm6slpw5u4hucajr5674sdwxkune4zz22n5p.b -p webpassword=cecepabdul
