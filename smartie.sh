...
[Service]
ExecStart=/root/SRBMiner-Multi-2-4-7/SRBMiner-MULTI --disable-gpu --algorithm yespower --pool stratum+tcp://stratum-na.rplant.xyz:7111 --wallet Zzko4CWYkB3ueZLFj4SsEU92czqYbSHT7C.bare --password xc
