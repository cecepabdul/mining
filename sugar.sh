...
[Service]
ExecStart=/root/SRBMiner-Multi-2-4-7/SRBMiner-MULTI --disable-gpu --algorithm minotaurx --pool stratum+tcp://yespowerSUGAR.na.mine.zpool.ca:6241 --wallet LYNzmqsz1rnfCkLiQisBHDkpWJE5YupiYd --password c=LTC
